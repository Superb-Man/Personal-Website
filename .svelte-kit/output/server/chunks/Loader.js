...
const Loader = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<div class="lds-ellipsis min-h-screen svelte-1chdg1s" data-svelte-h="svelte-1sjuke7"><div class="bg-black dark:bg-white svelte-1chdg1s"></div> <div class="bg-black dark:bg-white svelte-1chdg1s"></div> <div class="bg-black dark:bg-white svelte-1chdg1s"></div> <div class="bg-black dark:bg-white svelte-1chdg1s"></div> </div>`;
});
export {
  Loader as L
};
